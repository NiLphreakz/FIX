...
# // Exporting URL Host
export Server_URL="raw.githubusercontent.com/NiLphreakz/Blueblue/main/test"
export Server1_URL="raw.githubusercontent.com/NiLphreakz/Blueblue/main/limit"
...
export sem=$( curl -s https://raw.githubusercontent.com/NiLphreakz/Blueblue/main/test/versions)
